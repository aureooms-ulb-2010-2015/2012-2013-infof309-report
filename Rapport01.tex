...
\section{Différences}
\textit{Condensation} est présenté avec l'utilisation de \textit{splines} pour descripteurs \cite{condIsard}. Dans ce travail, le choix a été fait de baser le suivi sur des points robustes non mis en relation, à la manière d'un \textit{blob}.
